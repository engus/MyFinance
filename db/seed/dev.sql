...
VALUES
    ...
    ('00000000-0000-4000-8000-000000000209', '00000000-0000-4000-8000-000000000001', 'Unrealized gain / loss', 'EQUITY', 'equity', 'SYSTEM', 'USD', 'UNREALIZED_GAIN_LOSS'),
...
VALUES
    ...
    ('00000000-0000-4000-8000-000000000210', '00000000-0000-4000-8000-000000000001', 'Almaty apartment', 'ASSET', 'real_estate', 'USER', 'USD')
...
VALUES
    ...
    ('00000000-0000-4000-8000-000000000406', '00000000-0000-4000-8000-000000000001', 'REVALUATION', DATE '2026-08-09', 'Manual revaluation · Almaty apartment · 2026-08-09', '00000000-0000-4000-8000-000000000406')
ON CONFLICT (id) DO NOTHING;
...
FROM (VALUES
    ...
    ('00000000-0000-4000-8000-000000000511'::uuid, '00000000-0000-4000-8000-000000000406'::uuid, '00000000-0000-4000-8000-000000000210'::uuid, NULL::uuid, 125000::numeric, DATE '2026-08-09'),
    ('00000000-0000-4000-8000-000000000512'::uuid, '00000000-0000-4000-8000-000000000406'::uuid, '00000000-0000-4000-8000-000000000209'::uuid, NULL::uuid, -125000::numeric, DATE '2026-08-09')
...
WHERE id IN (
    ...
    '00000000-0000-4000-8000-000000000405', '00000000-0000-4000-8000-000000000406'
...
VALUES (
    ...
    'Almaty apartment', 'REAL_ESTATE', 'USD', 50,
    'Kazakhstan', 'Almaty', 'Private ownership',
    'Demo manual valuation. No external price provider is used.',
    '00000000-0000-4000-8000-000000000801'
)
ON CONFLICT (id) DO NOTHING;
...
VALUES (
    ...
    '00000000-0000-4000-8000-000000000001',
    '00000000-0000-4000-8000-000000000801',
    DATE '2026-08-09', 250000, 125000, 0, 125000,
    'Manual monthly value snapshot.',
    '00000000-0000-4000-8000-000000000901',
